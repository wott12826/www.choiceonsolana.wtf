...
const genLink = (tweet) => {
    //     return `
    // https://twitter.com/intent/tweet?url=https://choiceneighbor.xyz&hashtags=choice,choiceonsolana&text=${tweet}
    // `
    return `
https://twitter.com/intent/tweet?url=https://choiceneighbor.xyz&text=${tweet}
`
}
